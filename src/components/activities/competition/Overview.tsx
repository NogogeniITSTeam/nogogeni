...
function Overview({ name, description, imgPath }: OverviewProps) {
  ...
  return (
    <article className="pt-16 px-8 tablet:px-16 tablet:pt-24 desktop:px-32 desktop:pt-32">
      <div className="w-full mx-auto max-w-7xl">
        <h2 className="text-center font-bold text-[28px] desktop:text-[56px]">
          {name}
        </h2>
        <div className="mt-16 tablet:flex tablet:items-center tablet:gap-12 desktop:mt-20 desktop:gap-16">
